...
def test_date_2_datetime_ok(faker: Faker) -> None:
...
def test_str_2_datetime_ok(faker: Faker) -> None:
...
def test_str_2_datetime_naive_ok(faker: Faker) -> None:
    my_string_date = faker.date('%Y-%m-%d')
...
def test_str_2_datetime_invalid(faker: Faker) -> None:
...
def test_str_2_datetime_wrong_type(faker: Faker) -> None:
