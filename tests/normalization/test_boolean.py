import pytest
from jara_utils.normalization import is_dunder, is_email, str_2_bool
...
def test_str_2_bool(value: str, result: bool) -> None:
...
def test_is_dunder(value: str, result: bool) -> None:
